...
module.exports = async function cliquerSurSelecteurIframe(iframe, choixSelecteur, locateurSelecteur) {
    console.log("fonction cliquerSurSelecteurIframe");
  
    try {
        const aliasLocateur = String(locateurSelecteur);
        locateurSelecteur          = GetLocateur(aliasLocateur);
        const element        = await iframe.locator(locateurSelecteur);
        console.log(element);
